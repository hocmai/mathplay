...
<div class="form-group">
	...
	{{ Form::select('question_config[find][]', ['hieu' => 'Tìm hiệu số', 'a' => 'Tìm số a', 'b' => 'Tìm số b'], !empty($config['find']) ? $config['find'] : '', ['class' => 'form-control']) }}
</div>
<div class="row">
...
<div class="row">
	<div class="form-group col-sm-5">
		...
		{{ Form::number('question_config[min_value_2][]', isset($config['min_value_2']) ? $config['min_value_2'] : 1, ['class' => 'form-control pull-left', 'placeholder' => 'Số b nhỏ nhất']) }}
	</div>
	<div class="form-group col-sm-5">
