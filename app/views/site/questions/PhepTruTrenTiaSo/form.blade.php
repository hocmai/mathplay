...
<div class="form-group">
	...
	{{ Form::select('question_config[answer_type][]', ['' => 'Mặc định', 'input' => 'Nhập số', 'choose' => 'Chọn đáp án đúng'], !empty($config['answer_type']) ? $config['answer_type'] : '', ['class' => 'form-control']) }}
</div>
<div class="form-group">
	{{ Form::label('', 'Bắt đầu từ số:') }}
	{{ Form::number('question_config[min_value][]', !empty($config['min_value']) ? $config['min_value'] : 0, ['class' => 'form-control', 'placeholder' => 'Số đầu tiên', 'min' => -1]) }}
