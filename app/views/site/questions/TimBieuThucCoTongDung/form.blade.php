...
<div class="form-group">
	...
	{{ Form::select('question_config[answer_type]['.$id.']', ['' => 'Mặc định'] + TimBieuThucCoTongDung::getAnswerType(), !empty($config['answer_type']) ? $config['answer_type'] : '', ['class' => 'form-control pull-left']) }}
</div>
