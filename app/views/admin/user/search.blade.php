	...
	{{ Form::open(array('action' => 'UserController@search', 'method' => 'GET')) }}
		...
		<div class="input-group" style="width: 150px; display:inline-block;">
			<label>Từ ngày đăng nhập</label>
		  	<input type="date" name="start_date" class="form-control" id="datepickerStartdate" placeholder="Từ ngày" />
		</div>
		<div class="input-group" style="width: 150px; display:inline-block;">
			<label>Đến ngày đăng nhập</label>
		  	<input type="date" name="end_date" class="form-control" id="datepickerEnddate" placeholder="Đến ngày" />
		</div>
