...
<h4 class="inline-block" style="margin-left: 15px"><i class="fa fa-plus-circle btn btn-success" aria-hidden="true"></i> {{ link_to_action('LessionController@create', 'Thêm mới') }}</h4>
@stop
