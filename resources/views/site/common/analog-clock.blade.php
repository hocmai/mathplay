...
<circle class="clockBoundary" fill="none" stroke="{{ $color }}" stroke-width="14.2909" stroke-miterlimit="10" cx="193.2" cy="193.1" r="186" id="yui_3_14_0_1_1508756192488_946"></circle>
<g class="Fourth_qtr">
	<g class="mark45">
		<rect x="21" y="189.2" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark46">
		<circle fill="{{ $color }}" cx="25.8" cy="175.4" r="2.3"></circle>
	</g>
	<g class="mark47">
		<circle fill="{{ $color }}" cx="28.6" cy="158" r="2.3"></circle>
	</g>
	<g class="mark48">
		<circle fill="{{ $color }}" cx="33.4" cy="141.1" r="2.3"></circle>
	</g>
	<g class="mark49">
		<path fill="{{ $color }}" d="M40.6,122.6c-1.2-0.5-2.5,0-3.1,1.2c-0.5,1.2,0,2.5,1.2,3.1c1.2,0.5,2.5,0,3.1-1.2
			C42.3,124.5,41.8,123.1,40.6,122.6z"></path>
	</g>
	<g class="mark50">

			<rect x="43.6" y="105.2" transform="matrix(0.4999 -0.8661 0.8661 0.4999 -70.705 95.5458)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark51">
		<path fill="{{ $color }}" d="M58.5,92.3c-1-0.8-2.5-0.5-3.2,0.5c-0.8,1-0.5,2.5,0.5,3.2c1,0.8,2.5,0.5,3.2-0.5
			C59.8,94.5,59.5,93.1,58.5,92.3z"></path>
	</g>
	<g class="mark52">
		<circle fill="{{ $color }}" cx="68.3" cy="80.6" r="2.3"></circle>
	</g>
	<g class="mark53">
		<circle fill="{{ $color }}" cx="80.7" cy="68.2" r="2.3"></circle>
	</g>
	<g class="mark54">
		<path fill="{{ $color }}" d="M96.3,55.6c-0.8-1-2.2-1.3-3.2-0.5c-1,0.8-1.3,2.2-0.5,3.2c0.8,1,2.2,1.3,3.2,0.5
			C96.8,58.1,97,56.7,96.3,55.6z"></path>
	</g>
	<g class="mark55">
		<rect x="105.5" y="43.6" transform="matrix(0.866 -0.5 0.5 0.866 -9.0315 60.9524)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark56">
		<circle fill="{{ $color }}" cx="124.8" cy="39.5" r="2.3"></circle>
	</g>
	<g class="mark57">
		<circle fill="{{ $color }}" cx="141.1" cy="33.3" r="2.3"></circle>
	</g>
	<g class="mark58">
		<circle fill="{{ $color }}" cx="158.2" cy="28.6" r="2.3"></circle>
	</g>
	<g class="mark59">
		<circle fill="{{ $color }}" cx="175.6" cy="25.9" r="2.3"></circle>
	</g>
</g>
<g class="Third_qtr">
	<g class="mark45">
		<rect x="21" y="189.3" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark44">
		<circle fill="{{ $color }}" cx="25.8" cy="210.7" r="2.3"></circle>
	</g>
	<g class="mark43">
		<circle fill="{{ $color }}" cx="28.6" cy="228.1" r="2.3"></circle>
	</g>
	<g class="mark42">
		<circle fill="{{ $color }}" cx="33.4" cy="245" r="2.3"></circle>
	</g>
	<g class="mark41">
		<path fill="{{ $color }}" d="M40.6,263.4c-1.2,0.5-2.5,0-3.1-1.2c-0.5-1.2,0-2.5,1.2-3.1c1.2-0.5,2.5,0,3.1,1.2
			C42.3,261.5,41.8,262.9,40.6,263.4z"></path>
	</g>
	<g class="mark40">

			<rect x="43.6" y="273.3" transform="matrix(0.4999 0.8661 -0.8661 0.4999 263.6294 97.4966)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark39">
		<path fill="{{ $color }}" d="M58.5,293.7c-1,0.8-2.5,0.5-3.2-0.5c-0.8-1-0.5-2.5,0.5-3.2c1-0.8,2.5-0.5,3.2,0.5
			C59.8,291.5,59.5,293,58.5,293.7z"></path>
	</g>
	<g class="mark38">
		<circle fill="{{ $color }}" cx="68.3" cy="305.4" r="2.3"></circle>
	</g>
	<g class="mark37">
		<circle fill="{{ $color }}" cx="80.7" cy="317.8" r="2.3"></circle>
	</g>
	<g class="mark36">
		<path fill="{{ $color }}" d="M96.3,330.4c-0.8,1-2.2,1.3-3.2,0.5c-1-0.8-1.3-2.2-0.5-3.2c0.8-1,2.2-1.3,3.2-0.5
			C96.8,327.9,97,329.4,96.3,330.4z"></path>
	</g>
	<g class="mark35">
		<rect x="105.5" y="335" transform="matrix(0.866 0.5 -0.5 0.866 183.9876 -9.2336)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark34">
		<circle fill="{{ $color }}" cx="124.8" cy="346.6" r="2.3"></circle>
	</g>
	<g class="mark33">
		<circle fill="{{ $color }}" cx="141.1" cy="352.7" r="2.3"></circle>
	</g>
	<g class="mark32">
		<circle fill="{{ $color }}" cx="158.2" cy="357.4" r="2.3"></circle>
	</g>
	<g class="mark31">
		<circle fill="{{ $color }}" cx="175.6" cy="360.2" r="2.3"></circle>
	</g>
</g>
<g class="Second_qtr">
	<g class="mark16">
		<circle fill="{{ $color }}" cx="360.5" cy="210.7" r="2.3"></circle>
	</g>
	<g class="mark17">
		<circle fill="{{ $color }}" cx="357.7" cy="228.1" r="2.3"></circle>
	</g>
	<g class="mark18">
		<circle fill="{{ $color }}" cx="352.9" cy="245" r="2.3"></circle>
	</g>
	<g class="mark19">
		<path fill="{{ $color }}" d="M345.7,263.4c1.2,0.5,2.5,0,3.1-1.2c0.5-1.2,0-2.5-1.2-3.1c-1.2-0.5-2.5,0-3.1,1.2
			C344,261.5,344.5,262.9,345.7,263.4z"></path>
	</g>
	<g class="mark20">

			<rect x="335.1" y="273.3" transform="matrix(-0.4999 0.8661 -0.8661 -0.4999 748.2562 122.0441)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark21">
		<path fill="{{ $color }}" d="M327.8,293.7c1,0.8,2.5,0.5,3.2-0.5c0.8-1,0.5-2.5-0.5-3.2c-1-0.8-2.5-0.5-3.2,0.5
			C326.5,291.5,326.7,293,327.8,293.7z"></path>
	</g>
	<g class="mark22">
		<circle fill="{{ $color }}" cx="318" cy="305.4" r="2.3"></circle>
	</g>
	<g class="mark23">
		<circle fill="{{ $color }}" cx="305.6" cy="317.8" r="2.3"></circle>
	</g>
	<g class="mark24">
		<path fill="{{ $color }}" d="M290,330.4c0.8,1,2.2,1.3,3.2,0.5c1-0.8,1.3-2.2,0.5-3.2c-0.8-1-2.2-1.3-3.2-0.5
			C289.5,327.9,289.3,329.4,290,330.4z"></path>
	</g>
	<g class="mark25">
		<rect x="273.3" y="335" transform="matrix(-0.866 0.5 -0.5 -0.866 686.3503 493.5194)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark26">
		<circle fill="{{ $color }}" cx="261.5" cy="346.6" r="2.3"></circle>
	</g>
	<g class="mark27">
		<circle fill="{{ $color }}" cx="245.1" cy="352.7" r="2.3"></circle>
	</g>
	<g class="mark28">
		<circle fill="{{ $color }}" cx="228.1" cy="357.4" r="2.3"></circle>
	</g>
	<g class="mark29">
		<circle fill="{{ $color }}" cx="210.7" cy="360.2" r="2.3"></circle>
	</g>
	<g class="mark30">
		<rect x="189.5" y="357.9" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
</g>
<g class="First_qtr">
	<g class="mark15">
		<rect x="357.8" y="189.2" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark14">
		<circle fill="{{ $color }}" cx="360.5" cy="175.4" r="2.3"></circle>
	</g>
	<g class="mark13">
		<circle fill="{{ $color }}" cx="357.7" cy="158" r="2.3"></circle>
	</g>
	<g class="mark12">
		<circle fill="{{ $color }}" cx="352.9" cy="141.1" r="2.3"></circle>
	</g>
	<g class="mark11">
		<path fill="{{ $color }}" d="M345.7,122.6c1.2-0.5,2.5,0,3.1,1.2c0.5,1.2,0,2.5-1.2,3.1c-1.2,0.5-2.5,0-3.1-1.2
			C344,124.5,344.5,123.1,345.7,122.6z"></path>
	</g>
	<g class="mark10">

			<rect x="335.1" y="105.2" transform="matrix(-0.4999 -0.8661 0.8661 -0.4999 413.9218 456.9969)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark9">
		<path fill="{{ $color }}" d="M327.8,92.3c1-0.8,2.5-0.5,3.2,0.5c0.8,1,0.5,2.5-0.5,3.2c-1,0.8-2.5,0.5-3.2-0.5
			C326.5,94.5,326.7,93.1,327.8,92.3z"></path>
	</g>
	<g class="mark8">
		<circle fill="{{ $color }}" cx="318" cy="80.6" r="2.3"></circle>
	</g>
	<g class="mark7">
		<circle fill="{{ $color }}" cx="305.6" cy="68.2" r="2.3"></circle>
	</g>
	<g class="mark6">
		<path fill="{{ $color }}" d="M290,55.6c0.8-1,2.2-1.3,3.2-0.5c1,0.8,1.3,2.2,0.5,3.2c-0.8,1-2.2,1.3-3.2,0.5
			C289.5,58.1,289.3,56.7,290,55.6z"></path>
	</g>
	<g class="mark5">

			<rect x="273.3" y="43.6" transform="matrix(-0.866 -0.5 0.5 -0.866 493.3311 226.8452)" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
	<g class="mark4">
		<circle fill="{{ $color }}" cx="261.5" cy="39.5" r="2.3"></circle>
	</g>
	<g class="mark3">
		<circle fill="{{ $color }}" cx="245.1" cy="33.3" r="2.3"></circle>
	</g>
	<g class="mark2">
		<circle fill="{{ $color }}" cx="228.1" cy="28.6" r="2.3"></circle>
	</g>
	<g class="mark1">
		<circle fill="{{ $color }}" cx="210.7" cy="25.9" r="2.3"></circle>
	</g>
	<g class="mark0">
		<rect x="189.5" y="21.6" fill="{{ $color }}" width="7.5" height="7.5"></rect>
	</g>
</g>
...
<div class="hour-line" style="transform: rotate({{ ($hour*30)-90+( ( ($min/60)*100*30 )/100) }}deg);"></div>
<div class="min-line" style="transform: rotate({{ (($min/5)*30)-90 }}deg);"></div>